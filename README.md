...
## 🔄 自動アップデート機能 (v1.1.0以降)
GeppakuLab ランダム·システムは **v1.1.0以降**、プログラム内での自動アップデートをサポートします。  
これにより、GitHubを訪問することなく、新しいバージョンを簡単に取得できます。

### 📖 使用方法
1. **🚀 プログラム起動**  
   プログラムを起動すると自動的にアップデートを確認します。  
   ネットワーク権限を求められた場合は許可してください。

2. **🔔 アップデート確認**  
   新しいバージョンがある場合、更新確認画面が表示されます。  
   **Confirm ボタン**をクリックすると最新バージョンがダウンロードされ、インストーラーフォルダが自動で開きます。

3. **📂 インストール完了**  
   ダウンロードされたインストーラーを実行し、インストールを完了してください。
   *インストールを進める前に、現在実行中のプログラムを終了する必要があります。*

---

## 🛠️ 既存の方法
手動でアップデートを行いたい場合は、GitHubリリースページをご利用ください。  
🔗 [GitHub リリースページ](https://github.com/dev-SLH/GeppakuLabRandomSystem/releases)
